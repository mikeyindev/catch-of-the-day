...
class App extends React.Component {
    constructor() {
        // We can't call "this" until we've initialized React.Component with super()
        super();

        // Bind the addFish() to App component. In other words, to "this"
    ...
    addFish(fish) {
        ...
        // Using spread operator to clone the state. Copying the state before updating it
